          ...
          <div class="col-md-5 pl-0">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <span class="text-primary" v-text="`¥${p2.price.toFixed(2)}`"></span>
          ...
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <span class="text-primary" v-text="`¥${p3.price.toFixed(2)}`"></span>
              ...
              <div class="col-md-4 p-0 pl-2" v-for="(p,i) of others" :key="i">
                <div class="card border-0 text-center">
                  ...
                  <div class="card-body p-0 pr-1 pl-1">
                    ...
                    <span class="text-primary small" v-text="`¥${p.price.toFixed(2)}`"></span>
                    <router-link class="btn btn-primary btn-sm" :to="`/details/${p.href.split('=')[1]}`">查看详情</router-link>
                  </div>
                </div>
              </div>
            </div>
...
<script>
  ...
  export default {
    data(){
      return {
        p1:{price:0,href:""},//屏蔽.toFixed()错误和.split()错误
        p2:{price:0,href:""},
        p3:{price:0,href:""},
        others:[]//v-for="... of others"
        //arr=[];.length=0
