    ...
    <nav class="navbar navbar-light">
      ...
      <div class="form-inline">
        <div class="input-group">
          <input type="text" @keyup.13="search" v-model="kw" class="form-control p-0" placeholder="请输入你要搜索的内容" aria-label="Recipient's username" aria-describedby="basic-addon2">
          <div class="input-group-append h-75">
            <img class="btn p-0" src="img/header/search.png" @click="search">
          </div>
        </div>
      </div>
